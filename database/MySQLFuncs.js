...
const HOST = constants.dbConfig["host"];
const PORT = constants.dbConfig["port"];
const DATB = constants.dbConfig["name"];
const USER = constants.dbConfig["user"];
const PASS = constants.dbConfig["pass"];
...
let pool = mysql.createPool({
    ...
    user: USER, //The OS has a env variable called USER, causing an error on DB login.
    port: PORT, //constants.dbPort,
    password: PASS, //constants.dbPass,
    database: DATB, //constants.dbName,
    decimalNumbers: true,
